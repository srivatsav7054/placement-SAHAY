...
export const mockProfile = {
  ...
  summary:
    "Passionate software developer with experience in full-stack web development, seeking placement opportunities to apply my skills in a dynamic environment.",
  ...
  experience: [
    {
      ...
      description: "Built dashboard UI with React and Tailwind CSS.",
    },
  ],
  projects: [
    {
