        ...
        <div className="flex flex-1 flex-col overflow-hidden">
          ...
          <main className="flex-1 overflow-y-auto px-4 md:px-6 py-6">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h1 className="font-heading text-2xl font-bold text-foreground">Professional Profile</h1>
                <p className="text-sm text-muted-foreground">Manage all your information for building your resume.</p>
              </div>
            </div>

            <div className="flex gap-1 overflow-x-auto rounded-xl border border-border bg-muted/50 p-1.5 mb-6">
              {tabs.map((tab) => (
                <button
                  key={tab.id}
