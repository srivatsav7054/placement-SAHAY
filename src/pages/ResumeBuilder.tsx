...
const ResumeBuilder = () => {
  ...
  const handleUpdate = (nextData: Partial<ResumeData>) => {
    ...
    setResumes((current) =>
      current.map((resume) => (resume.id === activeId ? { ...resume, ...nextData } : resume))
    );
  };
      ...
      <div className="flex min-h-screen bg-background">
        ...
        <div className="flex flex-1 flex-col overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row flex-1 overflow-auto lg:overflow-hidden pt-0">
            ...
            {isError && !activeResume && !isLoading && user && (
              <div className="flex-1 p-6">
            ...
            {!isLoading && activeResume && user ? (
              <>
                ...
                <ResumePreview resume={activeResume} clerkUserId={user?.id} />
              </>
            ) : null}
